...
def get_main_keyboard():
    ...
    markup.add(types.InlineKeyboardButton('💎 أسعار النقاط', callback_data='main_prices'))
    markup.add(types.InlineKeyboardButton('💸 الشحن عبر التحويل', callback_data='main_transfer'),
